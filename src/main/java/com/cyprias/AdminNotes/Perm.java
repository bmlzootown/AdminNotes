...
public enum Perm {
	...
	INFO("adminnotes.info", "You do not have permission to see note info."),
	LOGIN_NOTIFIED("adminnotes.login-notified"),
	NOTIFY("adminnotes.notify", "You do not have permission to toggle notify."),
	...
	APPEND("adminnotes.append"), 
	MODIFY("adminnotes.modify"), 
	PARENT_MOD("adminnotes.mod", LIST, CREATE_NOTIFIED, INFO, LOGIN_NOTIFIED, SEARCH),
	PARENT_ADMIN("adminnotes.admin", PARENT_MOD, CREATE, APPEND, MODIFY, REMOVE, NOTIFY, RELOAD);
